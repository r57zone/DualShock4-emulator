...
Кнопка "PS" привязана на кнопку "Xbox", но для её использования нужно в настройках "Xbox Game Bar" отключить использованией этой кнопки. Также кнопка "PS" привязана на одновременное нажатие кнопок "Назад/Просмотр/Выбор" и "LB" (левый бампер) и на клавишу "F2".
